...
namespace Aidalab\MultiInventoryOverride\Observer;
...
class CheckoutAllSubmitAfterObserver extends \Amasty\MultiInventory\Observer\CheckoutAllSubmitAfterObserver
{
    /**
    ...
    /**
     * @var \Amasty\MultiInventory\Model\Warehouse\Order\Processor
     */
    private $orderProcessor;

    /**
     * CheckoutAllSubmitAfterObserver constructor.
     * @param \Amasty\MultiInventory\Model\Warehouse\Order\ItemFactory $orderItemFactory
    ...
    public function execute(EventObserver $observer)
    {
        ...
        foreach ($orders as $order) {
            try {
                /*Disable config DefinationWarehouse */
