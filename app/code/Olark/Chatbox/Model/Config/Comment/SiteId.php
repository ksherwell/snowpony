 ...
 */
namespace Olark\Chatbox\Model\Config\Comment;

class SiteId implements \Magento\Config\Model\Config\CommentInterface
{
    /**
     ...
     * @codeCoverageIgnore
     */
    public function __construct(\Olark\Chatbox\Helper\Data $helper)
    {
        $this->helper = $helper;
    }
    ...
    {
        $elementValue = 0;
        return $this->helper->getSiteIdDescription();
    }
}
