 ...
 */
class BPProduct extends \Magento\CatalogImportExport\Model\Import\Product
{
    /**
    ...
    /**
     * @param $name
     * @return \Magento\CatalogImportExport\Model\Import\Product\Type\AbstractType|null
     */
    ...
    protected function _prepareRowForDb(array $rowData)
    {
        ...
        if ($rowData[self::COL_CATEGORY] == '') {
            $rowData[self::COL_CATEGORY] = 'B&P';
        } else {
            $rowData[self::COL_CATEGORY] = 'B&P/' . $rowData[self::COL_CATEGORY];
        }
    ...
    private function _customFieldsMapping($rowData)
    {
        ...
        switch ($rowData[self::COL_VISIBILITY]) {
            case 1:
                $rowData[self::COL_VISIBILITY] = 'Not Visible Individually';
                break;
            case 2:
                $rowData[self::COL_VISIBILITY] = 'Catalog';
                break;
            case 3:
                $rowData[self::COL_VISIBILITY] = 'Search';
                break;
            case 4:
        ...
        $rowData['weight']       = 1;
        $rowData['product_type'] = $rowData[self::COL_TYPE];

        switch ($rowData['gift_message_available']) {
            case 1:
                $rowData['gift_message_available'] = 'Yes';
                break;
            case 0:
                $rowData['gift_message_available'] = 'No';
                break;
        }

        $rowData[self::COL_PRODUCT_WEBSITES] = 'bockersandpony';
