...
class USPSBase {
    ...
    protected function getXMLString() {
        ...
        $xml = \Magesales\AddressValidation\Model\XML\XMLParser::createXML($this->apiCodes[$this->apiVersion], $postFields);
        return $xml->saveXML();
    }
    /**
    ...
    public function convertResponseToArray() {
        if ($this->getResponse()) {
            $this->setArrayResponse(\Magesales\AddressValidation\Model\XML\XML2Array::createArray($this->getResponse()));
        }
