define([
        'jquery',
        'Magesales_AddressValidation/js/validation',
    ...
    function ($, magesalesAddressValidation, modal, $t, quote){
        'use strict';

        $.widget('mage.AddressValidationCheckout', $.mage.magesalesAddressValidation, {
            options: {
                urlValidation: "",
            ...
            checkIsExistingAddress:function(){
                this.isExistingAddress =
                    jQuery(".shipping-address-items").length == 1 &&
                    jQuery('.modal-popup._show #co-shipping-form').length == 0;
