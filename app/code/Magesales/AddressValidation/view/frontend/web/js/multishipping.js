...
function ($, magesalesAddressValidation){
    'use strict';

    $.widget('mage.magesalesAddressValidationMultishipping', $.mage.magesalesAddressValidation, {
        options: {
            urlValidation: "",
    ...
    return $.mage.magesalesAddressValidationMultishipping;
});