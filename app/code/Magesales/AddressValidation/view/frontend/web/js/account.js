...
function ($, modal, $t){
    ...
    $.widget('mage.magesalesAddressValidationAccount', {
        options: {
            urlValidation: "",
        ...
        _checkIsAddressValid:function(){
            ...
            this.request = $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $(self.options.nextStepButtonId).parent().append('<div style="clear:both"></div><div class="magesales-address-validation-error-message mage-error" generated="true">Please, update shipping address before continue.</div>')
                },
                complete: function() {
    ...
    return $.mage.magesalesAddressValidationAccount;
});