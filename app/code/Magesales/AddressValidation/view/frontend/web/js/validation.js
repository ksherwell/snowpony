define([
    ...
    function ($, modal, $t){
        ...
        $.widget('mage.magesalesAddressValidation', {
            ...
            showModal:function (response) {
                ...
                $('.magesales-address-validation-popup').removeClass('_show').addClass('_hide');

                modal({
                    title: $t(self.options.content.header),
                    content: response.modal_content,
                    modalClass: "magesales-address-validation-popup",
                    buttons:[
                        {
                            text: $t('Continue'),
                            class: '',
                            click: function() {
                                if (self.updateAddress(response)){
                                    ...
                                    $('.magesales-address-validation-popup .modal-content .mage-error').remove();
            ...
            checkCandidateAddress:function() {
                $(document).on('change', '.magesales-address-validation-popup input[name="candidate"]', function(){
                    $('.magesales-address-validation-popup .modal-content .mage-error').remove();
                });
            },
            ...
            whenAddressValid:function(){
                $('.magesales-address-validation-error-message').remove();
            ...
            disableBlocks: function(){
                $('.magesales-loader-for-av').show();
            },
            enableBlocks: function(){
                $('.magesales-loader-for-av').hide();
            },
            ...
            disableNextButton: function(message){
                ...
                $(this.options.nextStepButtonId).parent()
                    .append('<div style="clear:both"></div><div generated="true" class="magesales-address-validation-error-message mage-error">' +
                        $t(message) +
                        '</div>');
            },
        ...
        return $.mage.magesalesAddressValidation;
    });