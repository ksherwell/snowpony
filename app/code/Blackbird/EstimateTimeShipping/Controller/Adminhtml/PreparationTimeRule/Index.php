...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Estimate Time Shipping'), __('Estimate Time Shipping'));
        $resultPage->addBreadcrumb(__('Manage Preparation Time Rule'), __('Manage Preparation Time Rule'));
